...
$cred = Get-Credential -Message "MyMessage" -UserName "MyUserName"

$cred | Out-String | Write-Host 
...
$f = New-Object System.Management.Automation.Host.FieldDescription "Bool Value"
$f.SetparameterType( [switch] )
$f.DefaultValue = $false
$f.HelpMessage  = "You need to check"
$f.Label = "&Switch"
...
(
    [parameter(Mandatory=$true)]
    [System.IO.DirectoryInfo] $FileSelect,
    [parameter(Mandatory=$true)]
